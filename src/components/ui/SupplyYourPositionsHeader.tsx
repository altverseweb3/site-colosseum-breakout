...
const SupplyYourPositionsHeader = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row py-4 px-6 text-white w-full ">
        ...
        <div className="w-full sm:flex-grow flex justify-center items-center">
          <div className="flex items-center justify-center flex-wrap gap-2">
            <div className="rounded px-3 py-1 flex items-center gap-1 text-xs border h-6 border-zinc-800 text-white/50 flex-shrink-0">
              <span>balance</span>
            ...
            <div className="rounded px-3 py-1 flex items-center text-xs border h-6 border-zinc-800 flex-shrink-0 w-[112px] overflow-hidden">
